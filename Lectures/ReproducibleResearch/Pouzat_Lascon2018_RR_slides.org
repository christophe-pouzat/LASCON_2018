...
- Parameter setting (/eg/ the time step used for conductance based neuronal models).
...
- This is reasonable for we all have a lot of different things to do and we cannot afford to systematically look at every piece of work as thoroughly as suggested above.
\vspace{0.1cm}
